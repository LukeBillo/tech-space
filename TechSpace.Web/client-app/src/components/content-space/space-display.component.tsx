...
import { GenerateUniqueKeyForPost, TechnologySpacePost } from "../../models/technology-space-post.model";
	...
	return (
		<div className="SpaceDisplay p-3">
			<div className="space-posts grid grid-cols-3 grid-auto-rows-full gap-10 px-6 py-6">
				{posts.map(post => <PostTile key={GenerateUniqueKeyForPost(post)} post={post} />)}
			</div>
		</div>
	);
};